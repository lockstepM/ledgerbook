...
**Q — A wrongful-death suit against Alton claims $3M; counsel expects a $2.2M loss (probable), and separate insurance would cover $1.5M. Record the accrual, and state how to treat the remaining range and the insurance recovery.**
...
**Q — AAA Co. puts 1 coupon in each can; 5 coupons plus a redemption earn a premium that costs the company $2. It sells 1,500,000 cans, expects 70% of coupons to be redeemed, and 600,000 coupons have been redeemed by year-end. Compute the premium liability to accrue at year-end.**
...
This module covers **assurance-type** warranties (the product will work as promised) — accrue the **full expected warranty cost as a % of each year's sales** in the year of sale. Actual repair costs reduce the liability (credit cash — or credit **inventory** when defective units are replaced instead of repaired).

> [!TRAP]
> A **service-type / extended (separately-priced) warranty** is *not* accrued as expense — it's a **separate performance obligation** under ASC 606: defer the price as **unearned revenue** and recognize it **straight-line over the coverage period**. (See F2/M1 revenue recognition.) Only assurance-type warranties use the loss-accrual treatment below.

**Q — ABC Co. offers a 3-year warranty and replaces defective machines from inventory. Given sales of 250,000 / 500,000 / 750,000 over Years 1–3 and actual replacement costs of 10,000 / 20,000 / 30,000, build the warranty-liability roll-forward and give the year-of-sale accrual and the replacement entry.**

Work: total expected warranty cost = 2% + 4% + 6% = 12% of each year's sales, accrued in full in the year of sale.
