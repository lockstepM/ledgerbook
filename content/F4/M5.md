...
**Kristi Corp. discount example** ($1,000,000, 10% coupon, 12% market, sold for 926,399 → discount 73,601, 10 semiannual periods): SL amortization = 73,601 ÷ 10 = **7,360** per period; interest expense = 50,000 + 7,360 = **57,360** every period.
...
Same bond at an **8% market** → sold 1,081,109, premium 81,109 → SL amortization = 81,109 ÷ 10 = **8,111** per period; interest expense = 50,000 − 8,111 = **41,889** every period.
...
Discount bond (926,399) plus **$20,000** issue costs → net proceeds and initial CV = **906,399**; total discount 93,601; expense uses the **all-in effective rate 12.58%** (6.29% per period), while the 12% market rate still prices the bond:
...
**Perlin Corp.:** 10% bonds dated Jan 1, issued **April 1** at 926,399 (effective rate 12.08%); coupon dates 6/30 & 12/31:
...
Interest expense belongs to the period **incurred**, regardless of coupon dates. If coupons fall on July 1 / January 1, a **December 31 adjusting entry** is required (Kristi discount bond, CV 931,983 after the July payment):
