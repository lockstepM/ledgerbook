...
Example: 3-year lease, $18,000 year-end payments (ordinary annuity), 5.75% → PV = **48,338**:
...
Same liability (PV of payments), but the ROU asset can be **larger** (initial direct costs, prepayments). The asset and liability are then resolved **independently**, producing **two** income-statement lines:
...
Same facts as the operating example, but classified finance:
...
**Annuity due with initial direct costs** — 8-year lease from 1/1/Yr 5; $35,000/yr, first payment at commencement; $12,000 initial direct costs; implicit rate 4.5% known (use it over the 5% incremental rate); 4-year extension **unlikely** → ignored:
