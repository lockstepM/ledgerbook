...
**Foxy Inc.** took a $2,000 deduction ($420 tax savings). Read the full probability ladder and accumulate from the largest outcome down until the running total first passes 50%:

```schedule
{"caption": "UTP measurement — largest benefit with cumulative probability > 50%",
 "columns": ["Possible sustained benefit", "Individual probability", "Cumulative probability"],
 "rows": [
   ["$420", "26%", "26%"],
   ["$300", "25%", "51% ← first > 50% → recognize $300"],
   ["$200", "20%", "71%"],
   ["$100", "15%", "86%"],
   ["$0", "14%", "100%"]
 ]}
...
Recognize a **$300** benefit and record an **income tax liability of $120** ($420 taken − $300 sustained).
...
**Q — Julie Co. begins the year with a $2,000 DTL (a $10,000 temporary difference at the old 20% rate); a new $20,000 depreciation temporary difference arises this year and the enacted rate rises to 21%; current taxable income is $100,000. Remeasure the DTL to the new rate and record current and deferred tax.**

Work: required ending DTL = total temporary difference $30,000 × 21% = $6,300 → deferred adjustment = 6,300 − 2,000 = $4,300; current tax = 100,000 × 21% = $21,000.
...
> [!TRAP]
> **No carryback.** Post-2017 NOLs **cannot be carried back** — they only carry **forward** (indefinitely). Pre-2018 NOLs had a **2-year carryback** option (with a 20-year forward limit). Limited farming/insurance exceptions aside, a current-year loss produces **no immediate refund**.
...
A **valuation allowance** is required when it's **more likely than not (> 50%)** the NOL won't be used.

**Q — ABC Co. has a $60,000 NOL, but the only expected future income is $10,000 in 2026 (offset capped at 80%); rate 21%. Record the NOL deferred tax asset with the required valuation allowance.**

Work: total DTA = 60,000 × 21% = $12,600; usable income = 80% × 10,000 = $8,000 → usable DTA = 8,000 × 21% = $1,680; allowance on the rest = 52,000 × 21% = $10,920.
...
**Q — An investor owns 25% of an investee that reports $2,400,000 of net income and pays $2,000,000 in dividends; the 20–80% tier excludes 65% of dividends (DRD); rate 21%. Compute book income, the taxable dividend, current tax, and the DTL on the undistributed earnings, and record the entry.**

Work: book income = 25% × 2,400,000 = $600,000; dividends received = 25% × 2,000,000 = $500,000, 65% excluded → taxable = 500,000 × 35% = $175,000; current tax = 175,000 × 21% = $36,750; the $100,000 book-vs-tax temporary difference is 35% taxable = $35,000 → DTL = 35,000 × 21% = $7,350 (taxable < book → DTL).
...
> [!TRAP]
> **APB 23 indefinite-reinvestment exception.** For a **subsidiary's** undistributed earnings, **no DTL is recorded** if the parent asserts the earnings are **indefinitely reinvested** (never to be repatriated as a taxable dividend). This is the opposite of the investee/DRD case above, where a DTL **is** recorded. If the parent later changes that assertion, it records the previously-avoided DTL through continuing operations.
