...
**HTM example (TGPO):** $500,000 4-year bond bought at par, 4.25% (amortized cost stays $500,000). Now expected to collect only $11,500/year for 3 years. Factors: PV$1 = 0.88262, PV-annuity = 2.76198.
...
**AFS impairment:** the loss to **net income is capped at the expected credit loss**; any excess (from the market overreacting) goes to **OCI**. Same bond, amortized cost $500,000, ECL $26,927:
...
On **sale**, the realized gain/loss hits **net income** — but the computation and entry differ by classification (HTM isn't shown; you shouldn't sell it). Example: original cost 83, $2 of gains recorded over time → carrying value 85; sold for 90.
