...
> [!MNEMONIC]
> **Indirect operating method:** start with **net income**, then **+ depreciation, most amortization, bad-debt expense, bond-*discount* amortization, and losses**; **− gains and bond-*premium* amortization**; **− increases in operating assets / + increases in operating liabilities.**

Bond-**discount** amortization is a **non-cash interest expense → add back** (like depreciation); bond-**premium** amortization reduced interest expense with no extra cash → **subtract**.

The CPA exam tests the **indirect** method's math; investing and financing are the same regardless of method.

**Direct method (operating)** — reports actual cash flows; convert each accrual line to cash:

| Cash flow | Formula |
|---|---|
| Cash collected from customers | Sales − increase in AR (+ decrease) |
| Cash paid to suppliers | COGS + increase in inventory − increase in AP |
| Cash paid for operating expenses | Opex + increase in prepaid − increase in accrued liabilities |
| Cash paid for interest | Interest expense − bond-discount amort. (+ premium amort.) − increase in interest payable |
| Cash paid for income taxes | Tax expense − increase in taxes payable (± deferred tax change) |

> [!RULE]
> Even when a company presents operating cash by the **direct** method, GAAP still requires the **indirect reconciliation** (net income → operating cash) as a supplemental disclosure.
...
**Q — Cox Retail: net income $1,260; depreciation $445; bad-debt provision $200; gain on PP&E sale $80; accounts receivable +415; prepaids +25; inventory −205; operating liabilities +45. Compute net cash from operating activities using the indirect method.**
...
**Q — Cox Retail sold a facility with a net book value of 520 at an 80 gain, made capital expenditures of 1,000 (from the PP&E roll-forward), made a 150 note receivable (loan), and bought 750 of long-term marketable securities. Compute net cash used in investing.**
...
> [!EXAM]
> **Backing into capex** (when purchases aren't given): use the gross PP&E roll-forward — **beginning PP&E (gross) + purchases − cost of assets sold = ending PP&E (gross)**; solve for purchases. Separately, the sold asset's **NBV = its cost − accumulated depreciation removed**.
>
> **Gross-up warning:** if the problem gives AR **net** of the allowance, reconstruct the **gross** AR change and add back **bad-debt expense separately** in the operating section — don't net the two together.
...
**Q — Cox Retail borrowed 300 on its line of credit, issued 400 of long-term bonds, issued common stock for 500, and paid a 200 cash dividend. Compute net cash from financing — then, with operating 1,635, investing (1,300), and beginning cash 2,705, tie out to ending cash.**
...
> [!EXAM]
> **Deriving dividends paid** (when only retained earnings and payables are given): **dividends declared = beginning RE + net income − ending RE**; then **cash dividends paid = dividends declared − increase in dividends payable**. Only the **cash** figure hits the financing section.
