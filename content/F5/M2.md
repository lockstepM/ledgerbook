...
**Intercompany profit deferral.** When the investor and investee sell inventory or assets to each other (up- or downstream), the investor must **defer its ownership % of the unrealized profit** still sitting in the buyer's inventory/assets at year-end:

```journal
{"desc": "Defer investor's % of unrealized intercompany profit (reverse when sold to outsiders)",
 "dr": [["Equity in earnings", 8000]],
 "cr": [["Investment in affiliate", 8000]]}
```

The deferral **reverses** (DR Investment / CR Equity in earnings) in the period the goods are finally sold to an outside party.
...
**Transition (≥ 20% → < 20%, losing significant influence)** is likewise **prospective — no restatement**. The **carrying amount of the investment at the date significant influence is lost becomes the new cost basis**, and you apply the **fair-value (FV-through-NI)** method going forward (dividends resume being income; begin marking to market). You do **not** retroactively unwind prior equity-method earnings.

> [!TRAP]
> Dividends received under the equity method are a **return of capital** on the balance sheet, but on the **statement of cash flows** they are generally an **operating** inflow (the portion representing a return *of* the investment, judged under the nature-of-distribution/cumulative-earnings approach, is **investing**).
