...
**Special purpose frameworks / OCBOA** (Other Comprehensive Basis of Accounting) = non-GAAP bases with **widespread understanding and support**: cash basis, modified cash basis, and income-tax basis (also regulatory and contractual bases).
...
**ABC example** — cash collected 50,000, cash paid 20,000 (cash net income 30,000); AR +5,000; prepaid insurance +2,000; unearned revenue −15,000; salaries payable +4,000; $5,000 equipment bought (5-year SL, no salvage):
