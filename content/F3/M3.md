...
**Q — Apply lower of cost or NRV to two items: Item 1 cost 28.50 (sells for 30.00, cost to sell 3.00); Item 2 cost 21.00 (sells for 26.00, cost to sell 4.00). Compute each item's NRV and carrying value.**
...
**Q — Four items use LIFO, so apply lower of cost or market, where market is the middle of ceiling (NRV), replacement cost, and floor (NRV − normal profit). Given each item's cost, replacement cost, ceiling, and floor below, determine market and carry each item at the lower of cost or market.**
...
**Q — 50,000 units are bought at $6 each, then 20,000 units are sold at $7 (cost $5). Record the purchase and the sale under both the periodic and perpetual systems.**
...
**Q — Helix Corp. (Year 1, no beginning inventory) buys 4,000 units @ $4.25, 2,000 @ $4.50, and 3,000 @ $4.75 — 9,000 units, $40,250 available for sale — then sells 4,000 units, leaving 5,000. Compute COGS and ending inventory under FIFO, weighted average, moving average, and LIFO.** *(These shared facts feed the sub-sections below.)*
...
**Q — Brock Co.'s base-year inventory (1/1 Yr 1) is 40,000. Given each year's ending inventory at current-year cost and at base-year cost, compute the price index, the new layer (at base and at DV LIFO cost), and the dollar-value LIFO ending inventory for Years 1 and 2.**
...
> [!TRAP]
> **Layer liquidation — when ending inventory *at base-year cost* falls.** Peel off the **most recent layers first** (LIFO order), each removed at **its own year's index** — never re-price the base layer. Example: if base-year EI drops from 45,000 to 42,000, remove 3,000 from the most recent (Year-2) layer at the **Year-2** index; the base layer stays at 40,000 × 1.00. A liquidation pulls old, cheap costs into COGS.
...
**Q — Dahl Co. has beginning inventory 100,000, purchases 100,000, and sales 200,000, at a gross profit of 20% of sales. Estimate ending inventory using the gross profit method — then give the casualty loss if a flood destroys all of that ending inventory.**
...
Estimates ending inventory by tracking goods at both **cost** and **retail** (selling price), then applying a **cost-to-retail ratio**.

1. Goods available for sale at **cost** and at **retail**.
2. **Cost-to-retail ratio** = cost ÷ retail of goods available.
3. **EI at retail** = goods available at retail + net markups − net markdowns − net sales.
4. **EI at cost** = EI at retail × cost-to-retail ratio.

| Variant | Ratio includes | Effect |
|---|---|---|
| **Conventional (LCM/lower-of-cost-or-market)** | net markups **only** (exclude net markdowns) | lower ratio → **conservative** EI |
| **Cost (FIFO/LIFO) retail** | net markups **and** net markdowns | true cost approximation |

**Q — Goods available: cost 60,000, retail 100,000; net markups 10,000; net markdowns 5,000; net sales 80,000. Ending inventory under the conventional (LCM) retail method?**

Conventional ratio = 60,000 ÷ (100,000 + 10,000) = **54.5%** (markdowns excluded from the ratio). EI at retail = 110,000 − 5,000 − 80,000 = **25,000**. EI at cost = 25,000 × 54.5% = **≈ 13,636**.
