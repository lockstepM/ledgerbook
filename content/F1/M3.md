...
- **Participating** — after both classes get their base rate, preferred shares in the excess **pro rata**. **Fully** participating = no cap; **partially** = capped at a **stated ceiling rate**.
  - *Partial mechanics:* preferred participates in the excess **only up to its ceiling**; once preferred has received its capped amount, **all remaining dividends go entirely to common**. *Mini-example:* preferred par $100,000, base 6%, **partially participating up to 9%**. Base to preferred = $6,000; preferred's participation is capped at the extra 3% = **$3,000 max** (total preferred $9,000). Any dividend beyond what funds the two base rates plus that $3,000 cap belongs **100% to common** — preferred does **not** keep sharing pro rata.
...
**Q — Sam Co. has fully participating, cumulative preferred: preferred par $250,000 @ 8% and common par $500,000 @ 8%; no dividend was declared in Yr 1; $101,000 is declared in Yr 2. Allocate the $101,000 between preferred and common (arrears → current-year base → participation in the remainder pro rata).**
...
**Q — Under the cost method, record the full sequence: original issuance of 10,000 shares ($10 par) at $15; buy back 200 shares at $20; reissue 100 at $22; then reissue the remaining 100 at $13. Track where each reissuance gain/loss lands (APIC–treasury stock, then retained earnings).**
...
**Q — Using the par value method (stock originally issued at $15 on $10 par, so $5 premium per share), record each independent case: (a) buy back 200 shares at $20, (b) buy back 200 shares at $12, and (c) reissue 100 shares from the $12 lot at $22.**
