...
**Default/forfeiture** (subscriber never pays in full) gives the corporation **three** options — issue shares **pro rata** to cash paid, **refund** the money, or (where allowed) **keep it as liquidated damages**. Under the **pro-rata** option, **shares issued = cash collected ÷ full subscription price per share** (e.g., paid $5,000 toward 200 shares subscribed at $100 → issue **50** shares; the balance of the subscription is reversed). **Refund** simply reverses the subscription and returns the cash (DR Common stock subscribed + APIC / CR Cash). The forfeiture option:
